py_binary(
    ...
    srcs = [
        ...
        "mesonbuild/backend/bazel/bazel_rules.py",
        "mesonbuild/backend/bazel/build_target_generator.py",
        "mesonbuild/backend/bazel/custom_target_generator.py",
        "mesonbuild/backend/bazel/header_extractor.py",
        "mesonbuild/backend/bazelbackend.py",
